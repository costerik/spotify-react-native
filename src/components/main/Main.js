  ...
  render() {
    return (
      <View style={styles.wrapperContainer}>
        <Video source={BgVideo} style={styles.backgroundVideo} muted resizeMode="cover" repeat />
        <View style={styles.container}>
          ...
          <View style={styles.wrapperSwiper}>
            <Swiper autoplay activeDotColor="#FFF" style={styles.swiper} dotStyle={styles.dot}>
          ...
          <View style={styles.wrapperButtons}>
            ...
            >
              <Text style={styles.buttonText}>{'continue with facebook'.toUpperCase()}</Text>
            </TouchableOpacity>
